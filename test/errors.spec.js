...
describe('errors', () => {
    ...
    describe.concurrent('UtilsGDriveError', () => {
        ...
        describe.concurrent('file id not specified', () => {
            ...
            const testFileIdNotSpec = (method, argsMethod) => testUtilsGDriveError(method, argsMethod, errorMessage);
        ...
        describe.concurrent('invalid identifier name', () => {
            ...
            const errorMessage = new RegExp(`^Invalid property name: ${Object.keys(identifiers)[0]}$`);
            const testInvalidIdent = (method, argsMethod) => testUtilsGDriveError(method, argsMethod, errorMessage);
...
async function testUtilsGDriveError(method, argsMethod, errorMessage) {
    ...
    expect(() => { throw err; }).toThrowError(UtilsGDrive.Error);
